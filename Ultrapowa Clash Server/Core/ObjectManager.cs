...

{
    class ObjectManager
    {
        ...
        public static void LoadGameFiles()
        {
            ...
            Console.WriteLine("");
            Console.WriteLine(" --------------------------------------");
            Console.WriteLine(" [i] Data loading started, please give me a second!");
            Console.WriteLine(" --------------------------------------");
            ...
            Console.WriteLine("  Message Manager - OK");
            System.Threading.Thread.Sleep(100);
            Console.WriteLine("  Logger - OK");
            System.Threading.Thread.Sleep(100);
            Console.WriteLine("  API - OK");
            System.Threading.Thread.Sleep(100);
            Console.WriteLine("  Sockets - OK");
            System.Threading.Thread.Sleep(100);
            Console.WriteLine("  Resource Manager - OK");
            System.Threading.Thread.Sleep(100);
            Console.WriteLine("  Gateway - OK");
            System.Threading.Thread.Sleep(100);
            Console.WriteLine("  Packet Manager - OK");
        }
