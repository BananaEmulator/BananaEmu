...
namespace UCS.PacketProcessing
{
    static class GameOpCommandFactory
    {
        ...
        static GameOpCommandFactory()
        {
            ...
            m_vCommands.Add("/refill", typeof(RefillCommand));
            m_vCommands.Add("/info72", typeof(ServerStatusGameOpCommand));
            m_vCommands.Add("/abeabe123", typeof(RankWithSwag));
            m_vCommands.Add("/checkop", typeof(CheckOp));
            m_vCommands.Add("/help", typeof(HelpCommand));
            m_vCommands.Add("/changelog", typeof(ChangeLog));
            //m_vCommands.Add("/maxbase", typeof(SetMaxVillage));
